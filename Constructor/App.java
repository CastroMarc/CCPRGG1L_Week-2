public class App {
    public static void main(String[] args) {
        ...
        thief.sayMyName();
         ...
         Character healer = new Character(10, 5, 10, "pneumonoultramicroscopicsilicovolcanoconiosis");
         // Calls the sayMyName method
         healer.sayMyName();

         // Creates a new object named "archer" from Character class
         Character archer = new Character(100, 80, 90, "supercalifragilisticexpialidocious");
         // Calls the sayMyName method
         archer.sayMyName();
    }
}
